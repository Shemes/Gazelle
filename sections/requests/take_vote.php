...
if ($LoggedUser['BytesUploaded'] >= $Amount && $Filled === '0') {
	...
	NotificationsManager::notify_users($UserIDs, NotificationsManager::REQUESTALERTS, Gazelle\Format::get_size($Amount) . " of bounty has been added to a request you've voted on!", "requests.php?action=view&id=" . $RequestID);
