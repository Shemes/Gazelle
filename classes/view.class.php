...
class View {
	...
	public static function show_header($PageTitle = '', $JSIncludes = '', $CSSIncludes = '') {
		...
		if (!is_array(\Gazelle\G::$LoggedUser) || empty(\Gazelle\G::$LoggedUser['ID']) || $PageTitle == 'Recover Password :: ' . SITE_NAME) {
	...
	public static function show_footer($Options = array()) {
		...
		if (!is_array(\Gazelle\G::$LoggedUser) || (isset($Options['recover']) && $Options['recover'] === true)) {
