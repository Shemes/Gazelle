...
<?	if (!empty($LastActive)) { ?>
	<p>
		<a href="user.php?action=sessions">
			<span class="tooltip" title="Manage sessions">Last activity: </span><?=\Gazelle\Util\Time::timeDiff($LastActive['LastUpdate'])?><span class="tooltip" title="Manage sessions"> from <?=$LastActive['IP']?>.</span>
		</a>
	</p>
<?	} ?>
	<p>
		<strong>Time:</strong> <span><?=number_format(((microtime(true) - $ScriptStartTime) * 1000), 5)?> ms</span>
		<strong>Used:</strong> <span><?=Gazelle\Format::get_size(memory_get_usage(true))?></span>
