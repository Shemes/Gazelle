 ...
 */
	...
	if (\Gazelle\G::$LoggedUser['DisablePosting']) {
		return;
	}
						...
						<tr class="colhead_dark">
							<td colspan="<?=(Users::has_avatars_enabled() ? 2 : 1)?>">
								<div style="float: left;"><a href="#quickreplypreview">#XXXXXX</a>
									by <strong><?=Users::format_username(\Gazelle\G::$LoggedUser['ID'], true, true, true, true)?></strong> Just now
								</div>
...
<?	if (Users::has_avatars_enabled()) { ?>
							<td class="avatar" valign="top">
								<?=Users::show_avatar(\Gazelle\G::$LoggedUser['Avatar'], \Gazelle\G::$LoggedUser['ID'], \Gazelle\G::$LoggedUser['Username'], $HeavyInfo['DisableAvatars'])?>
							</td>
<?	} ?>
...
<?
		...
		if ($ThreadInfo['LastPostAuthorID'] == \Gazelle\G::$LoggedUser['ID']) {
...
<?
		...
		if (!\Gazelle\G::$LoggedUser['DisableAutoSave']) {
?>
