	...
	switch ($Result['Page']) {
		...
		case 'requests':
			...
			if ($CategoryName == 'Music') {
				$Links .= \Gazelle\Artists::display_artists(Requests::get_artists($Result['PageID'])) . '<a href="requests.php?action=view&amp;id=' . $Result['PageID'] . '" dir="ltr">' . $Request['Title'] . " [" . $Request['Year'] . "]</a>";
