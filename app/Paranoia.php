...
// call \Gazelle\Paranoia::check in /classes/script_start.php without ensuring check_perms has been defined
...
class Paranoia
{
    public static function check($Property, $Paranoia, $UserClass, $UserID = false)
    {
        global $Classes;
        if ($Property == false) {
            return false;
        ...
        if (is_array($Property)) {
            ...
            foreach ($Property as $P) {
                $all = $all && self::check($P, $Paranoia, $UserClass, $UserID);
            }
            return $all;
        } else {
