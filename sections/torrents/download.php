...
if (!is_array($Info) || !array_key_exists('PlainArtists', $Info) || empty($Info[10])) {
	...
	$Artists = \Gazelle\Artists::get_artist($Info[0][4]);
	$Info['Artists'] = \Gazelle\Artists::display_artists($Artists, false, true);
	$Info['PlainArtists'] = \Gazelle\Artists::display_artists($Artists, false, true, false);
